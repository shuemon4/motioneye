...
"""
Module: V4L2 video device detection and control management
Functions: find_v4l2_ctl(), list_devices(), list_resolutions(), device_present(), find_persistent_device(), list_ctrls()
"""
